...
class By {
   ...
   */
  static js(script: any, ...var_args: any[]) {
   ...
   * @return {!By} The new locator.
   */
  static partialLinkText(text: string) {
...
export function withTagName(tagName: any) {
  return new RelativeBy({ 'css selector': tagName })
}


export function locateWith(by: By) {
  return new RelativeBy(getLocator(by))
}

function getLocator(locatorOrElement:any) {
  let toFind
...
export class RelativeBy {
  private readonly root: By;
  private readonly filters: Array<object>;

  constructor(findDetails: any, filters?: any[]) {
   ...
   */
  above(locatorOrElement: { toObject: () => any }) {
    this.filters.push({
      kind: 'above',
   ...
   * @return {!RelativeBy} Return this object
   */
  below(locatorOrElement: { toObject: () => any }) {
    this.filters.push({
      kind: 'below',
      args: [getLocator(locatorOrElement)],
    })
   ...
   * @return {!RelativeBy} Return this object
   */
  toLeftOf(locatorOrElement: { toObject: () => any }) {
    this.filters.push({
      kind: 'left',
      args: [getLocator(locatorOrElement)],
    })
   ...
   * @return {!RelativeBy} Return this object
   */
  toRightOf(locatorOrElement: { toObject: () => any }) {
    this.filters.push({
      kind: 'right',
      args: [getLocator(locatorOrElement)],
    })
   ...
   * @return {!RelativeBy} Return this object
   */
  near(locatorOrElement: { toObject: () => any }) {
    this.filters.push({
      kind: 'near',
      args: [getLocator(locatorOrElement)],
    })
 ...
 *     strategy.
 */
export function check(locator:  any) {
